    ...
    public class Messages {
        ...
        public static void mainMenu(int incompleteTaskCount, int completedTaskCount) {
            ...
            System.out.println("6. Look task shortly");
            System.out.println("7. Look task with description");
            System.out.println("8. Exit from the ListRunner");
        ...
        /**
         * This method will display the Edit menu options on standard output (terminal) for user selection
         */
